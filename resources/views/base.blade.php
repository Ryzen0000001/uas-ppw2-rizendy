    ...
    <div class="max-w-screen-xl flex flex-wrap gap-3 items-center justify-between mx-auto p-4">
        <a href="#" class="flex items-center space-x-2 rtl:space-x-reverse">
            ...
            <div class="flex flex-col leading-tight">
                <span class="text-lg md:text-xl font-bold text-[#631913]">Rizendy Affarin</span>
                <span class="text-xs md:text-sm font-semibold text-[#631913]">535196</span>
            </div>
        </a>
            ...
            <div class="flex flex-col sm:flex-col md:flex-row md:justify-between gap-6">
                ...
                <div>
                    <div class="text-white text-right">
                        ...
                        <p>Rizendy Affarin</p>
                        <p>535196</p>
                        <p>Kelas B1 - Praktikum Pemrograman Web 2</p>
                    </div>
                </div>
            </div>
