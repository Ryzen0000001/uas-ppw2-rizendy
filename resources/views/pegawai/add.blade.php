        ...
        <div class="mx-auto max-w-screen-xl">
            <form action="{{ route('pegawai.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="email" name="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" required>
                </div>
                <div>
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" name="is_active" value="1" checked class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded">
